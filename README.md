...
Generating synthetic data to extend TL;DR for having input paired data for SFT of a pretrained summarizer. You can find the details in the file `main.ipynb`.
